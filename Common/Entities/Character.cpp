...
namespace Engine
{
    ...
    void Character::Animate()
    {
        ...
        if(state == EntityState::Walking && m_spriteSheet.get_current_type() != KnightAnimations::Walk)
        {
            m_spriteSheet.SetAnimation(KnightAnimations::Walk,true,true);
        }
        else if(state == EntityState::Jumping && m_spriteSheet.get_current_type() != KnightAnimations::Jump)
        {
            m_spriteSheet.SetAnimation(KnightAnimations::Jump,true,false);
        }
        else if(state == EntityState::Attacking && m_spriteSheet.get_current_type() != KnightAnimations::Attack)
        {
            m_spriteSheet.SetAnimation(KnightAnimations::Attack,true,false);
        } 
        else if(state == EntityState::Dying && m_spriteSheet.get_current_type() != KnightAnimations::Death)
        {
            m_spriteSheet.SetAnimation(KnightAnimations::Death,true,false);
        }
        else if(state == EntityState::Idle && m_spriteSheet.get_current_type() != KnightAnimations::Idle)
        {
            m_spriteSheet.SetAnimation(KnightAnimations::Idle,true,true);
        }
        else if(state == EntityState::Hurt && m_spriteSheet.get_current_type() != KnightAnimations::Hurt)
        {
            m_spriteSheet.SetAnimation(KnightAnimations::Hurt,true,false);
        }
    }
