...
namespace Engine
{
    ...
    {
        CollisionElement(float l_area, std::shared_ptr<Tile> l_tile,  const sf::FloatRect& l_bounds):
            m_area(l_area),
            m_tile(l_tile), 
    ...
    public:
        ...
        uint32_t get_layer_number() const;
    ...
    protected:
        ...
        std::shared_ptr<Tile> m_referenceTile; // Tile underneath entity.
